...
@WebAppConfiguration
public class TestCreateTicketWithFilesLimit {
    ...
    @Test
    public void testCreateTicketWithWriteFileLimit() throws DataGridConnectionRefusedException, DataGridTicketException,
            JargonException {
