...
@WebAppConfiguration
public class TestCreateTicketWithHostRestriction {
    ...
    @Test
    public void testCreateTicketWithHostRestriction() throws DataGridConnectionRefusedException, DataGridTicketException, JargonException {
